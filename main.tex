...
\resumeProjectHeading
     % {\href{https://github.com/typhonshambo/ai-styleguide}{\textbf{\large{\underline{\textbf{ai-styleguide-assistant}}}} \href{Project Link}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{\underline{Google GenAI, Flask, Streamlit, VS-code Test}}}{2024-Present}\\
      {\href{https://github.com/typhonshambo/ai-styleguide}{\textbf{\large{\underline{\textbf{Ai Style-guide Assistant}}}} \href{Project Link}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{\underline{Google GenAI, Flask, Streamlit, VS-code Test}}}{2024-Present}\\
      \resumeItemListStart
        \resumeItem{\normalsize{Developed an AI-powered style-guide assistant using Google Gemini GenAI, helping developers write clean, consistent style code, reducing instances of clutter and bad code by up to 80\%}}
        \resumeItem{\normalsize{Integrated the assistant into VS Code and a web interface, automating code formatting and providing real-time style suggestions for both small scripts and large codebases with a single click}}
        \resumeItem{\normalsize{Assistant can be customized as per the user's or team's need allowing flexibility in coding style and maintenance.}}
      \resumeItemListEnd 
            \vspace{-13pt}
