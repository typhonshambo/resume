...
\hline
\textbf{MLOps} & \hspace{0.1cm}ZenML, PyArrow, MLflow, Streamlit, Dagshub \\
\hline
...
\hline
\textbf{Others} & \hspace{0.1cm}Discord/Telegram Bot development, Git and Github, Repl, IntelliJ \\
\hline
\end{tabularx}
\end{center}
