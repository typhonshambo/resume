...
\hline
\textbf{Languages} & \hspace{0.1cm}Python, C, SQL, Bash, Latex \\
\hline
\textbf{Data Science} & \hspace{0.1cm}Pandas, NumPy, SciKit-Learn, Matplotlib, Seaborn, BeautifulSoup4 \\
\hline
\textbf{MLOps} & \hspace{0.1cm}ZenML, PyArrow, MLflow, Streamlit \\
\hline
\textbf{DevOps} & \hspace{0.1cm}CI/CD pipeline, Github Actions, AWS, GCP \\
\hline
\textbf{DBMS} & \hspace{0.1cm}PostgreSQL, MongoDB, MySQL \\
\hline
\textbf{Hosting} & \hspace{0.1cm}AWS Elastic Beanstalk, Azure App Service, Heroku \\
\hline
\textbf{Frameworks} & \hspace{0.1cm}Flask, Web Scrapping, REST-API\\
\hline
\textbf{OS Platforms} \hspace{0.1cm}& \hspace{0.1cm}Windows (7,8,8.1,10,11), Ubuntu (20.xx,22.xx, 22.xx), Debian, MacOS X, Chrome-OS \\
\hline
\textbf{Others} & \hspace{0.1cm}Discord/Telegram Bot development, Git and Github, Jupyter Notebook, Repl, IntelliJ \\
\hline
\end{tabularx}
\end{center}
