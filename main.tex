...
\hline
\textbf{Languages} & \hspace{0.1cm}Python, C, SQL, Bash \\
\hline
\textbf{Data Science} \hspace{0.1cm} & \hspace{0.1cm}Data visualization \& wrangling, Statistical analysis, ML modelling\\
\hline
\textbf{MLOps} & \hspace{0.1cm}ZenML, MLflow, Streamlit, Dagshub \\
\hline
\textbf{DevOps} & \hspace{0.1cm}CI/CD pipeline, Github Actions, AWS Elastic Beanstalk, GCP GKE\\
\hline
\textbf{DBMS} & \hspace{0.1cm}PostgreSQL, MongoDB, MySQL \\
\hline
\textbf{Hosting} & \hspace{0.1cm}Azure App Service, Heroku \\
\hline
\textbf{Frameworks} & \hspace{0.1cm}Flask, REST-API\\
\hline
\textbf{Others} & \hspace{0.1cm}Discord/Telegram Bot development, Web Scrapping \\
\hline
\end{tabularx}
\end{center}
