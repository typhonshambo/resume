...
\hline
\textbf{DevOps} & CI/CD pipeline, Github Actions, Amazon Web Service (AWS), Google Cloud Platforms (GCP), Microsoft Azure \\
\hline
\textbf{DBMS} & PostgreSQL, MongoDB, MySQL \\
\hline
\textbf{Hosting} & AWS Elastic Beanstalk, Azure App Service, Heroku \\
\hline
...
\hline
\textbf{Others} & Discord/Telegram Bot development, Git and Github, Jupyter Notebook, Repl, VS Code, IntelliJ \\
\hline
\end{tabularx}
\end{center}
