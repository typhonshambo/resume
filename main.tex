...
\textbf{Data Science} \hspace{0.1cm} & \hspace{0.1cm}Data visualization \& wrangling, Statistics, ML modelling\\

\textbf{MLOps} & \hspace{0.1cm}ZenML, MLflow, Streamlit, Dagshub \\

\textbf{DevOps} & \hspace{0.1cm}CI/CD, Github Actions, AWS EC2, GCP GKE\\
